...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white fw-bold pt-2" aria-current="page" href="/adminLogOut">Log Out</a>
                  </li> 
            </ul>
          </div>
        </div>
      ...
      <h2 class="text-center mt-4" >Add Item To Cart</h2>
      <div class="container ">
          <div class="row ">
      ...
      <form action="{{url('/add')}}" method="POST">
        ...
        <div class="mb-3 mt-4">
            ...
            <input type="text" class="form-control" name="gallery" aria-describedby="urlHelp">
          </div>
        <div class="mb-3">
            <label for="exampleInputDescrition" class="form-label">Description of the Product</label>
            <input type="text" class="form-control" name="description"  aria-describedby="descriptionHelp">
          </div>
        <div class="mb-3">
            <label for="exampleInputPrice" class="form-label">Quantity of the Product</label>
            <input type="number" class="form-control" name="quantity" aria-describedby="quantityHelp">
          </div>
